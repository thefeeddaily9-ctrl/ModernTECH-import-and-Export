...
const translations: Translation = {
  ...
  'hero.title': { en: 'Your Trusted Link to', zh: '您到优质产品的', de: 'Ihre vertrauenswürdige Verbindung zu', ar: 'رابطك الموثوق إلى' },
  'hero.title.span': { en: 'Agricultural Heritage', zh: '农业遗产', de: 'Landwirtschaftlichem Erbe', ar: 'التراث الزراعي' },
  'hero.title.growth': { en: 'and Steady Growth', zh: '和稳健增长', de: 'und stetigem Wachstum', ar: 'ونمو ثابت' },
  ...
  'hero.description': { en: 'From our farms in Oromia to the global market. We are farmers first, building a credible reputation through steady growth and professional trade.', zh: '从我们在奥罗米亚的农场到全球市场。我们首先是农民，通过稳步增长和专业贸易建立可靠的声誉。', de: 'Von unseren Farmen in Oromia auf den Weltmarkt. Wir sind zuerst Farmer und bauen durch stetiges Wachstum und professionellen Handel einen glaubwürdigen Ruf auf.', ar: 'من مزارعنا في أوروميا إلى السوق العالمية. نحن مزارعون أولاً، نبني سمعة موثوقة من خلال النمو المطرد والتجارة المهنية.' },
  ...
  // Footer
  'footer.hq': { en: 'Addis Ababa HQ', zh: '亚的斯亚贝巴总部', de: 'Hauptsitz Addis Abeba', ar: 'المقر الرئيسي في أديس أبابا' },
  'footer.uae': { en: 'Dubai Operations', zh: '迪拜运营部', de: 'Dubai Niederlassung', ar: 'عمليات دبي' },
  'footer.technologies': { en: 'Moderntech Technologies', zh: 'Moderntech 技术', de: 'Moderntech Technologien', ar: 'مودرنتيك للتكنولوجيا' },
  'footer.manufacturing.tech': { en: 'Tech Assembly', zh: '技术组装', de: 'Tech-Montage', ar: 'تجميع التكنولوجيا' },
  'footer.manufacturing.domestic': { en: 'Manufacturing', zh: '制造业', de: 'Fertigung', ar: 'التصنيع' },
